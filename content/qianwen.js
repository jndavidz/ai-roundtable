...
(function() {
  ...
  const LOAD_FLAG = '__AIPanelContentLoaded_qianwen';
  ...
  async function injectMessage(text) {
    ...
    if (!inputEl) throw new Error('Could not find Qianwen input field');
    ...
    console.log('[AI Panel] Qianwen message sent via', submitResult.method);
  ...
  const RESPONSE_SELECTORS = ['[class*="markdown"]', '[class*="message"] [class*="content"]', '[class*="bubble"]', '[class*="answer"]'];
